void setup() {
    ...
    RenderOptions options = new RenderOptions(500, 500, 1, 16, 4, 4, 2.0, 2.2, 0);
    
    Camera camera = new Camera(radians(30.0), new Film(options.width, options.height), new PMatrix3D());
    camera.lookAt(new PVector(0, 0, 35), new PVector(0, 0, 0), new PVector(0, 1.0, 0));
    
    Diffuse diffuse = new Diffuse(new PVector(1, 1, 1));
    ...
    Sphere lightBall = new Sphere(new PVector(0, 2, 0), 1, null, true, new PVector(1, 1, 1));
