class ShaderGlobals {
    ...
    public ShaderGlobals(PVector point, PVector normal, PVector uv, PVector tangentU,
                         PVector tangentV, PVector viewDirection, PVector lightDirection,
                         PVector lightPoint, PVector lightNormal) {
        this.point = point;
        this.normal = normal;
        this.uv = uv;
